    ...
    return (
        <tr className=' border-b border-gray-300 hover:bg-gray-50'>
            ...
            <td className='p-3 border-l border-gray-100 text-center'>
                ...
                onClick={() => navigate(`/${id}`)} >Ver Cliente</button>
                ...
                onClick={() => navigate(`/edit/${id}`)}>Editar</button>
                <button type='button' className='bg-red-600 hover:bg-red-700 block w-full text-white p-2 uppercase font-bold text-xs mt-2 rounded-md' 
